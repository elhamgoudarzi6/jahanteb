...
export class ProfileComponent implements OnInit {
  ...
  formGroupPassword: FormGroup | any;
  formGroupMobileChange: FormGroup | any;
  ...
  loadInfoUser() {
    if (this.localStorage.getCurrentUser() === true) {
      ...
      this.userService.getUser(this.user.id).subscribe((response: any) => {
  ...
  updateUser() {
    this.user.id = this.localStorage.userJson['id'];
    this.userService.updateUser(this.user.id, this.user).subscribe((response: any) => {
      if (response['success'] === true) {
  ...
  changePasswordUser() {
    this.userService.changePasswordUser(this.user.id, this.changePassword).subscribe((response: any) => {
      if (response['success'] === true) {
  ...
  changeMobileNumber() {
    this.userService.changeMobileNumber(this.localStorage.userToken,this.user.id, this.mobilePassword).subscribe((response: any) => {
      if (response['success'] === true) {
        this.loadInfoUser();
  ...
  onUpload(event: any) {
    ...
    this.userService.uploadProfileFile(formData).subscribe((response: any) => {
      if (response['success'] === true) {
