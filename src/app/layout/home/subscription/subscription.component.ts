...
export class SubscriptionComponent implements OnInit {
  ...
  addEmailSubscription(): void {
    this.service.addEmailSubscription(this.emailForm.value).subscribe((response:any) => {
  ...
  addSmsSubscription(): void {
    this.service.addSmsSubscription(this.mobileForm.value).subscribe((response:any) => {
