...
export class SubscriptionUsersComponent implements OnInit {
  ...
  getSmsList(): any{
    this.service.getAllSmsSubscriptions().subscribe((response:any) => {
  ...
  getEmailList(): any{
    this.service.getAllEmailSubscriptions().subscribe((response:any) => {
      if (response.success === true) {
  ...
  deleteSms(id: any): void {
    this.confirmationService.confirm({
      ...
      accept: () => {
        // delete from db
        this.service.deleteSmsSubscription(id).subscribe((response:any) => {
          if (response.success === true) {
  ...
  deleteEmail(id: any): void {
    this.confirmationService.confirm({
      ...
      accept: () => {
        // delete from db
        this.service.deleteEmailSubscription(id).subscribe((response:any) => {
          if (response.success === true) {
            this.confirmationService.close();
            this.messageService.add({severity: 'success', summary: ' حذف اطلاعات ', detail: response.data});
            this.getEmailList();
