...
export class CommentsComponent implements OnInit {
  ...
  getComments(): any{
    this.service.getAllComments().subscribe((response:any) => {
  ...
  activeComment(id: any): void {
    this.confirmationService.confirm({
      ...
      accept: () => {
        // active comment
        this.service.activeOrDeactiveComment(id, {active: true}).subscribe((response:any) => {
          if (response.success === true) {
  ...
  deactiveComment(id: any): void {
    this.confirmationService.confirm({
      ...
      accept: () => {
        // deactive comment
        this.service.activeOrDeactiveComment(id, {active: false}).subscribe((response:any) => {
          if (response.success === true) {
            this.confirmationService.close();
  ...
  deleteComment(id: any): void {
    this.confirmationService.confirm({
      ...
      accept: () => {
        // delete from db
        this.service.deleteComment(id).subscribe((response:any) => {
          if (response.success === true) {
            this.confirmationService.close();
