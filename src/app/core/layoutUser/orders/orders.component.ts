...
export class OrdersComponent implements OnInit {
  cols: any[]|any;
  orderList: any[]|any;
  orderListModel: OrdersModel[]|any;
  ...
  getOrders(id: any) {
    this.userService.getAllOrderByUser(this.localStorage.userToken,id).subscribe((response:any) => {
  ...
  deleteOrderUser() {
    this.userService.deleteOrder(this.localStorage.userToken,this.idOrderForDel).subscribe((response:any) => {
      if (response.success=== true) {
        this.getOrders(this.localStorage.userJson['id']);
  ...
  showDialogEditOrder(id: any) {
    ...
    this.detailOrder = this.orderListModel.filter((item:any) => item._id === id);
  ...
  updateOrder(idOrder: any) {
    ...
    this.userService.updateOrder(this.localStorage.userToken,idOrder, data).subscribe((response:any) => {
      if (response.success === true) {
        this.getOrders(this.localStorage.userJson['id']);
        this.messageService.add({severity: 'success', summary: 'موفق', detail: response['data']});
        this.productDialog = false;
